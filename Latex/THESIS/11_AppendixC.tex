...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.95\textwidth]{{"Latex/THESIS/Figures/scrapy_architecture"}.png}
...
\multicolumn{1}{l}{\textbf{}} & \textbf{Number of Crawler Retrieved Sites} & \textbf{Number of Sites after Preprocessing / Cleaning} \\ \hline
\textbf{United Kingdom}  & \textbf{6185}   & \textbf{380} \\
\textbf{Germany (total)} & \textbf{165384} & \textbf{71}  \\
Germany Federal Level             & 200             & 23           \\
Baden-Wuerttemberg       & 130             & 9           \\
Bavaria                  & 230             & 5            \\
Berlin                   & 70543           & 8            \\
Brandenburg              & 169             & 1            \\
Bremen                   & 1329            & 6            \\
