...
Looking at the matching sites that the scraper yielded from 'gov.uk' reveals the the following patterns over time (see Figure~\ref{fig:British organisations over time} on next page). As in the case of Germany, the very first content on agile methods was published by a central government ministerial department,\footnote{For a distinction between all British central government ministerial departments over time see Figure~\ref{fig:British ministries over time} in \href{Appendix A}{Appendix A}. Grouping of institutions according to \url{https://www.gov.uk/government/organisations}. } namely the Cabinet Office (comparable to the federal government / Bundesregierung) – however, 4 years earlier.\footnote{Link: \url{https://webarchive.nationalarchives.gov.uk/20110410092517/http://innovate.direct.gov.uk/
...
In terms of average number of co-search terms, the Home Office clearly leads the ranking with 9 co-search terms per site, followed by the Department for Work \& Pensions and the the Education \& Skills Funding Agency (both 7) (see Figure~\ref{fig:British agile depth organisation} in \href{Appendix A}{Appendix A}). However, this result might be slightly misleading as the crawler only yielded one page for the Home Office which, in addition, is \href{https://hodigital.blog.gov.uk/category/agile/}{an overview page about agile}.\footnote{Link: \url{https://hodigital.blog.gov.uk/category/agile/}.}
...
As can be seen in Figure~\ref{fig:Breadth and depth of agile* websites published by British and German ministries} (see next page), the most active British ministerial department in this respect is the Cabinet Office (22 published sites in total), while in Germany it is the Federal Ministry of Labour and Social Affairs (12 published sites).\footnote{See also Figure~\ref{fig:German ministries over time} and Figure~\ref{fig:British ministries over time} in \href{Appendix A}{Appendix A} for a depiction over time.} In terms of highest number of average co-search terms per site, the German Federal Government and the British Home Office are dead even. Yet, the crawler only yielded one page for each of these institution, and thus this high number might be skewed. Over all, it has to be noted that total number of ministries publishing agile related content on their web presences is nearly double for Britain (11 vs. 6 ministries), and the total average of agil* sites published as well as the total average number of co-search terms per site is higher for British ministries (4 and 2.47 for Germany vs. 5 and 4.55 for the UK – see neon yellow markers in Figure~\ref{fig:Breadth and depth of agile* websites published by British and German ministries}).
...
\begin{figure}[ht!]
	\centering
	 ...
	 \caption[Breadth and depth of agile* websites published by British and German ministries]{Breadth and depth of agile* websites published by British and German ministries\footnotemark}
...
\begin{figure}[ht!]
    ...
    \includegraphics[width=0.485\textwidth]{{"Analysis/3_Data_Analysis/visualisations/wordcloud_germany_ministries"}.pdf} & \includegraphics[width=0.485\textwidth]{{Analysis/3_Data_Analysis/visualisations/wordcloud_uk_ministries"}.pdf}
    \end{tabular}
...
\footnotetext{As can be seen by the yellowish gray colour on x=5, y=3.8, the British Department for Transport and the Department for Health \& Social Affairs yielded the exact same results. For the full names of the respective ministries, please refer to Figure~\ref{fig:Breadth and depth of agil* websites published by British and German ministries (with ministry names)} in \href{Appendix A}{Appendix A}.}