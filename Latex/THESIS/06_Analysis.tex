...
\begin{figure}[ht!]
	\centering
	 \includegraphics[width=1\textwidth]{{"Analysis/3_Data_Analysis/visualisations/british_vs_German_federal_ministries_over_time"}.pdf}
	 \caption[Agile* websites published over time by British and German ministries]{Agile* websites published over time by British and German ministries}
	 \label{fig:Agile* websites published over time by British and German ministries}
\end{figure}
%
\begin{figure}[ht!]
	\centering
