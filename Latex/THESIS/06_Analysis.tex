...
\end{wrapfigure}
only the federal state ministries are compared for the following inter country comparison. 
...
As can be seen in Figure~\ref{fig:Breadth and depth of agile* websites published by British and German ministries}, the most active British ministerial department in this respect is the Cabinet Office (22 published sites in total), while in Germany it is the Federal Ministry of Labour and Social Affairs (12 published sites).\footnote{See also Figure~\ref{fig:German ministries over time} and Figure~\ref{fig:British ministries over time} in \href{Appendix A}{Appendix A} for a depiction over time.} In terms of highest number of average co-search terms per site, the German Federal Government (Bundesregierung.de) and the British Home Office are dead even. Yet, the crawler only yielded one page for each of these institution, and thus this high number might be skewed. Lastly, it has to be noted that total number of ministries publishing agile related content on their web presences is nearly double for Britain (11 vs. 6 ministries). 
...
%
When comparing the frequency of co-search terms appearing on the respective sites between British and German ministries (see Figure~\ref{fig:wordclouds}, it can 
