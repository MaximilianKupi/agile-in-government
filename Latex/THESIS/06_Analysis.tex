...
\end{figure}
%
When comparing the content published by the ministerial web domains of the federal states, it can be seen that Baden-Wuerttemberg's ministries have published the most number of websites referring to agile (12 pages), followed by Bavaria (8 pages), Bremen and Berlin (each 7 pages). 
\begin{figure}[ht!]
	\centering
	\begin{tabular}{c c}
